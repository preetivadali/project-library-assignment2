...
document.getElementById('genre-select').addEventListener('change', filterAndSortBooks);
document.getElementById('sort-select').addEventListener('change', filterAndSortBooks);
